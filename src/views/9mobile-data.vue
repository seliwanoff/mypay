    ...
    <div class="parent-specify">
       <div class="form-data">
        <form @submit.prevent="handleSubmit">
            ...
            <option value="MD127">9MOBILE 150MB   (&#8358;200)  </option>
            <option value="MD128">9MOBILE 1GB     (&#8358;1000) </option>
            <option value="MD129">9MOBILE 1.5GB   (&#8358;1200) </option>
            <option value="MD130">9MOBILE 2.5GB   (&#8358;2000) </option>
            <option value="MD131">9MOBILE 4GB     (&#8358;3000)</option>
            <option value="MD132">9MOBILE 11GB     (&#8358;8000)</option>
