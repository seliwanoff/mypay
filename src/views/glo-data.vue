    ...
    <div class="parent-specify">
       <div class="form-data">
        <form @submit.prevent="handleSubmit">
            ...
            <option value="MD110">GLO 35MB  (&#8358;100)  </option>
            <option value="MD111">GLO 100MB  (&#8358;200) </option>
            <option value="MD112">GLO 800MB  (&#8358;500) </option>
            <option value="MD113">GLO 1.6GB  (&#8358;1000) </option>
            <option value="MD114">GLO 3.75GB (&#8358;2000)</option>
            <option value="MD115">GLO 5GB    (&#8358;2500)</option>
            </select>
            </div>
             <div class="form-group">
