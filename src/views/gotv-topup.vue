        ...
        <form @submit.prevent="handleSubmit">
            <div class="form-group-logo">
                ...
                <div class="img-icon-mtn">
                 <img src="../assets/images/gotv.png" alt="" srcset="">
                </div>
            </div>
            <div class="form-group">
            <label for="Recipient">SmartCard Number</label>
            ...
            <option value="CB137">GOTV Light  (&#8358;1050)  </option>
            <option value="CB138">GOTV Value  (&#8358;1200) </option>
            <option value="CB139">GOTV Plus   (&#8358;1800) </option>
