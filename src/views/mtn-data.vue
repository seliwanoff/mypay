        ...
        <form @submit.prevent="handleSubmit">
            <div class="form-group-logo">
                <div class="checkbalance">
                    <h3>Buy Data</h3>
                   <span>Use *131*4# to check balance</span>
                </div>
            ...
            <label for="Recipient">Recipient</label>
             ...
             <select v-model="packages" class="each-data" >
                <option value="MD104">MTN 50MB   (&#8358;100)  </option>
               <option value="MD105">MTN 150MB  (&#8358;200) </option>
               <option value="MD106">MTN 750MB  (&#8358;500) </option>
               <option value="MD107">MTN 1.5GB  (&#8358;1000) </option>
               <option value="MD108">MTN 3.5GB  (&#8358;2000) </option>
               <option value="MD109">MTN 5 GB   (&#8358;3500)</option>
            </select>
            </div>
             <div class="form-group">
